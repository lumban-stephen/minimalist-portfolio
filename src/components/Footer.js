...
const Footer = ({ toggleColorMode, colorMode }) => {
  return (
    <footer className="fixed bottom-0 left-0 right-0 bg-customYellow p-8 flex justify-between items-center">
      <div className="flex space-x-8">
        <a href="https://www.linkedin.com/in/lumbanstephen/" target="_blank" rel="noopener noreferrer">
          <FaLinkedin className="text-5xl hover:text-blue-500" />
        </a>
        <a href="https://github.com/lumban-stephen" target="_blank" rel="noopener noreferrer">
          <FaGithub className="text-5xl hover:text-blue-500" />
        </a>
        <a href="https://www.facebook.com/lmbnstpn" target="_blank" rel="noopener noreferrer">
